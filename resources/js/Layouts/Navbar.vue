   ...
   <div class="modal fade" id="editProfileModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                          ...
                          <div class="row">
                              <div class="col-md-12">
                                 ...
                                 <div v-if="user?.role === 2 || user?.role === 3">
                                    ...
                                    <input type="text" class="form-control form-control-sm mb-3" v-model="editProfileForm.contactNumber" required>
                                 </div>
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row shadow-sm">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          ...
          <button class="navbar-toggler navbar-toggler align-self-center d-none d-lg-flex" @click="insidebar" type="button" data-toggle="minimize">
        ...
        <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
          ...
          <ul class="navbar-nav navbar-nav-right">
            ...
            <li class="nav-item nav-profile dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">
                <a class="dropdown-item" @click.prevent="editProfile(user?.name, null, user?.email)" href="#" v-if="user?.role === 1">
                  <i class="fa-solid fa-user"></i> My Account
                </a>
                <a class="dropdown-item" @click.prevent="editProfile(user?.personnel.name, user?.personnel.contactNumber, user?.email)" href="#" v-if="user?.role === 2">
                  <i class="fa-solid fa-user"></i> My Account
                </a>
                <a class="dropdown-item" @click.prevent="editProfile(user?.applicant.name, user?.applicant.contactNumber, user?.email)" href="#" v-if="user?.role === 3">
                  <i class="fa-solid fa-user"></i> My Account
                </a>
                <hr>
          ...
          <button class="navbar-toggler navbar-toggler-right d-lg-none align-self-center" type="button" @click="sidebar" data-toggle="offcanvas">
            <span class="typcn typcn-th-menu"></span>
          </button>
        </div>
      </nav>
