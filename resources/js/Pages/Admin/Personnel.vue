...
const updatePersonnelData = () => {
    ...
    editForm.patch(route('admin.update-personnel'), {
        onFinish: () => {
                    ...
                    <div class="modal-content">
                        ...
                        <form action="" @submit.prevent="createPersonnelData">
                            <div class="modal-body">
                                ...
                                <input type="text" class="form-control form-control-sm mb-3" v-model="createForm.name" required>

                                <label for="" class="mb-1">Position</label>
                                <input type="text" class="form-control form-control-sm mb-3" v-model="createForm.position" required>

                                <label for="" class="mb-1">Contact Number</label>
                                <input type="number" class="form-control form-control-sm mb-3" v-model="createForm.contactNumber" required>

                                <label for="" class="mb-1">Email</label>
                                <input type="email" class="form-control form-control-sm mb-3" v-model="createForm.email" required>

                                <label for="" class="mb-1">Password</label>
                                <input type="password" class="form-control form-control-sm" v-model="createForm.password" required>
                            </div>
                    ...
                    <div class="modal-content">
                        ...
                        <form action="" @submit.prevent="updatePersonnelData">
                            <div class="modal-body">
                                ...
                                <label for="" class="mb-1">Full Name</label>
                                <input type="text" class="form-control form-control-sm mb-3" v-model="editForm.name" required>

                                <label for="" class="mb-1">Position</label>
                                <input type="text" class="form-control form-control-sm mb-3" v-model="editForm.position" required>

                                <label for="" class="mb-1">Contact Number</label>
                                <input type="number" class="form-control form-control-sm mb-3" v-model="editForm.contactNumber" required>

                                <label for="" class="mb-1">Email</label>
                                <input type="email" class="form-control form-control-sm mb-3" v-model="editForm.email" required>

                                <label for="" class="mb-1">Password</label>
                                <input type="password" class="form-control form-control-sm" v-model="editForm.password">
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-sm btn-secondary" data-bs-dismiss="modal">Close</button>
                                <button type="" class="btn btn-sm btn-primary">Save</button>
                                    ...
                                    <tbody>
                                        <tr v-for="(ps, index) in personnel">
                                            ...
                                            <td>
                                                ...
                                                <a href="#" class="p-2" @click.prevent="deletePersonnelData(ps.id)">
