                ...
                <div class="col-md-6">
                    <div class="card rounded-md">
                        ...
                        <div class="card-body shadow-md">
                            <p class="text-wrap text-justify text-sm mb-4">Pushbullet's API enables developers to build on the
                            ...
                            <form action="" @submit.prevent="updateSMSToken">
                                <label for="">URL</label>
                                <input type="text" class="form-control form-control-sm mb-3" :value="sms.url" readonly>

                                <label for="">Access Token</label>
                                <input type="text" class="form-control form-control-sm mb-3" v-model="editForm.accessToken">

                                <label for="">Mobile Identity</label>
                                <input type="text" class="form-control form-control-sm mb-3" v-model="editForm.mobileIdentity">
